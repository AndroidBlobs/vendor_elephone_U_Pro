...
include $(CLEAR_VARS)
LOCAL_MODULE := SnapdragonMusic
LOCAL_MODULE_OWNER := elephone
LOCAL_SRC_FILES := proprietary/vendor/app/SnapdragonMusic/SnapdragonMusic.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := arima-ads
LOCAL_MODULE_OWNER := elephone
LOCAL_SRC_FILES := proprietary/vendor/app/arima-ads/arima-ads.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
